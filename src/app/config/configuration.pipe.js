...
var ConfigurationPipe = (function () {
    function ConfigurationPipe(config) {
        this.config = config;
    }
    ConfigurationPipe.prototype.transform = function (value) {
        return this.config.get(value, undefined);
    };
    return ConfigurationPipe;
}());
ConfigurationPipe = __decorate([
    core_1.Pipe({ name: 'config' }),
    __metadata("design:paramtypes", [configuration_service_1.ConfigurationService])
], ConfigurationPipe);
exports.ConfigurationPipe = ConfigurationPipe;
